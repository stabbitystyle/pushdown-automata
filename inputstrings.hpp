...
// The InputStrings class is a class which is responsible for holding the string list, which is the list of strings the user might want to test against the pushdown automata.
// It can add and remove strings from the list, display the list, and save the list to file if the list changed from the original list at any point.
class InputStrings
{
    private:
